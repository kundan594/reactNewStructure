...
import Feature  from 'containers/Feature/Loadable';
        ...
        <nav className="bg-white border-b border-gray-200">
            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                  ...
                  <a href="#" className="border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium" aria-current="page"> Dashboard </a>

                  <a href="#" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"> <Link to="/Feature">Feature</Link></a>
          ...
          <div className="sm:hidden" id="mobile-menu">
            <div className="pt-2 pb-3 space-y-1">
              ...
              <a href="#" className="bg-indigo-50 border-indigo-500 text-indigo-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" aria-current="page"> Dashboard </a>
